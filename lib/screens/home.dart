import 'package:eat_experts/screens/details.dart';
import 'package:eat_experts/widgets/widget.support.dart';
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          Text("Fresh and Healthy", 
                              style: AppWidget.LightTextFeildStyle(),),
                              SizedBox(height: 5.0,),
                              Text("\$25", style: AppWidget.semiBooldTextFeildStyle(),)
                        ]),
                      ),
                    ),
                  ),
                    ...
                    children: [
                      ...
                      Column(children: [
                        Container(
                          ...
                          child: Text("Mediterranean Chickpea Salad", style: AppWidget.semiBooldTextFeildStyle(),)),
                        SizedBox(height: 5.0,),
                        Container(
                          width: MediaQuery.of(context).size.width/2,
