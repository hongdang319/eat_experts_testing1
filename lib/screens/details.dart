        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Mediaterranean", style: AppWidget.semiBooldTextFeildStyle(),),
            ...
            Text(
              ...
              Row(children: [
                Text("Prep Time", style: AppWidget.semiBooldTextFeildStyle(),),
                SizedBox(width: 25.0,),
                Icon(Icons.alarm, color: Colors.black54,),
                SizedBox(width: 5.0,),
                Text("15 mins", style: AppWidget.semiBooldTextFeildStyle(),),
              ],),
              Spacer(),
              Padding(
